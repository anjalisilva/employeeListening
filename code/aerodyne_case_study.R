...
# case study question 1 analysis
...
# case study question 3 analysis: assess equity exposure and outcomes 
run_question3 <- function(
  ...
  list(
    equity_by_gender = equity_by_gender,
...
# case study question 4: sensitivity analysis and action priorities 
